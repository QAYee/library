<div class="col-md-4 mb-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Category: <?php echo $books["description"]?></p>
                        <p class="card-text">Stock: <?php echo $books["author"]?></p>
                        <p class="card-text">Stock: <?php echo $books["category"]?></p>
